...
#         self.add_class(config.NAME,1,"copymove")
        self.add_class(config.NAME,1,"splicing")
...
#                 labels_form.append("copymove")
            if labels[i].find("splicing") != -1:
                # print "box"
                labels_form.append("splicing")
#             elif labels[i].find("splicing") != -1:
#                 #print "column"
#                 labels_form.append("splicing")
...
model_path = os.path.join(MODEL_DIR, "mask_rcnn_shapes_0020.h5")  # 修改成自己训练好的模型
